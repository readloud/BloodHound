...
[How To get started](https://github.com/readloud/BloodHound/blob/master/INSTALL.md) with BloodHound, check out the [BloodHound docs.](https://bloodhound.readthedocs.io/en/latest/index.html)
